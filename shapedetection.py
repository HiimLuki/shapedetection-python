...
cv2.createTrackbar("thresh", "Trackbars", 219, 255, nothing)
...
while True:
    ...
    #thresh bestimmt wie viel erkannt wird --> je keiner desto mehr wird erkannt, Wert der am besten funktioniert bei mir: 219
    #maxval (da wo 255 steht) gibt den kontrast vom neuen bild an --> 255 heißt alles komplett schwarz und weiß
    #statt THRESH_BINARY_INV geht auch THRESH_BINARY dann werden dunkle sachen erkannt
